...
# 1 "room1BG.h" 1
# 22 "room1BG.h"
extern const unsigned short room1BGTiles[208];
...
void goToSplash() {
    ...
    *(volatile unsigned short*)0x4000008 = 0<<14 | 0 << 2 | 30 << 8;
    ...
    DMANow(3, splashBGTiles, &((charblock *)0x6000000)[0], 3680 / 2 | (1 << 31));
...
void goToInstr() {
    ...
    *(volatile unsigned short*)0x4000008 = 0<<14 | 0 << 2 | 30 << 8;
    ...
    DMANow(3, instrBGTiles, &((charblock *)0x6000000)[0], 6784 / 2 | (1 << 31));
...
void goToRoom(int roomNum) {
    if (roomNum == 0) {
        ...
        *(volatile unsigned short*)0x4000008 = 0<<14 | 0 << 2 | 30 << 8;
        DMANow(3, gameUITiles, &((charblock *)0x6000000)[0], 416 / 2 | (1 << 31));
        DMANow(3, gameUIMap, &((screenblock *)0x6000000)[30], 2048 / 2 | (1 << 31));
        ...
        *(volatile unsigned short*)0x400000A = 0<<14 | 1 << 2 | 29 << 8;
        ...
        DMANow(3, room1BGTiles, &((charblock *)0x6000000)[1], 416 / 2 | (1 << 31));
