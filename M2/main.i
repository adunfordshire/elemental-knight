...
void init() {
    ...
    *(volatile unsigned short*)0x4000008 = 0<<14 | 0 << 2 | 30 << 8;
    ...
    DMANow(3, splashBGTiles, &((charblock *)0x6000000)[0], 1472 / 2 | (1 << 31));
...
void goToGame() {
    ...
    *(volatile unsigned short*)0x4000008 = 0<<14 | 0 << 2 | 30 << 8;
    ...
    DMANow(3, gameBGTiles, &((charblock *)0x6000000)[0], 192 / 2 | (1 << 31));
    DMANow(3, gameBGMap, &((screenblock *)0x6000000)[30], 2048 / 2 | (1 << 31));
    state = GAME;
}
void goToPause() {
    *(unsigned short *)0x4000000 = 0 | (1<<8);
