...
void updatePlayer(PLAYER * player) {
    ...
    if ((~(*(volatile unsigned int *)0x04000130) & ((1<<6)))) {
        player->dir = UP;
        if (player->spriteRow > 0 && collisionMapBitmap[((player->spriteRow - 1)*(256)+(player->spriteCol))]
            && collisionMapBitmap[((player->spriteRow - 1)*(256)+(player->spriteCol + player->width - 1))]
            && collisionMapBitmap[((player->spriteRow - 1)*(256)+(player->spriteCol + player->width/2 - 1))]) {
    ...
    if ((~(*(volatile unsigned int *)0x04000130) & ((1<<7)))) {
        player->dir = DOWN;
        if (player->spriteRow < 256 - player->height && collisionMapBitmap[((player->spriteRow + player->width + 1)*(256)+(player->spriteCol))]
            && collisionMapBitmap[((player->spriteRow + player->height)*(256)+(player->spriteCol + player->width - 1))]
            && collisionMapBitmap[((player->spriteRow + player->height)*(256)+(player->spriteCol + player->width/2 - 1))]) {
    ...
    if ((~(*(volatile unsigned int *)0x04000130) & ((1<<5)))) {
        player->dir = LEFT;
        if (player->spriteCol > 0 && collisionMapBitmap[((player->spriteRow)*(256)+(player->spriteCol - 1))]
            && collisionMapBitmap[((player->spriteRow + player->height - 1)*(256)+(player->spriteCol - 1))]
            && collisionMapBitmap[((player->spriteRow + player->height/2 - 1)*(256)+(player->spriteCol - 1))]) {
    ...
    if ((~(*(volatile unsigned int *)0x04000130) & ((1<<4)))) {
        player->dir = RIGHT;
        if (player->spriteCol < 256 - player->width && collisionMapBitmap[((player->spriteRow)*(256)+(player->spriteCol + player->width))]
            && collisionMapBitmap[((player->spriteRow + player->height - 1)*(256)+(player->spriteCol + player->width))]
            && collisionMapBitmap[((player->spriteRow + player->height/2 - 1)*(256)+(player->spriteCol + player->width))]) {
...
void playerAttack(PLAYER * player) {
    ...
    playSoundB(attackZap, 5632, 11025, 0);
    player->attack = 1;
}
